...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboardDekan', [DashboardController::class, 'dashboardDekan'])->name('dashboardDekan');
    Route::get('/dashboardKaprodi', [DashboardController::class, 'dashboardKaprodi'])->name('dashboardKaprodi');
    Route::get('/dashboardDoswal', [DashboardController::class, 'dashboardDoswal'])->name('dashboardDoswal');
});
